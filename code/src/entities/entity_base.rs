...
pub struct BaseEntity{
    ...
    offset_pos: (u32,u32), //Possible to change into a single u32 where first 16 bits are q and last 16 bits are r /too save space
}

impl BaseEntity{
    pub fn new(player_id: u8, render_id: u32,health: i32, power:u32,attack_range: u16, movement: u16, offset_pos: (u32,u32)) -> BaseEntity{
        BaseEntity{
            player_id: player_id,
            render_id: render_id,
            health: health,
    ...
    pub fn get_offset_pos(&self) -> (u32,u32){
        self.offset_pos
    }
